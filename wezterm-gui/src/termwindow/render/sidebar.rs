...
"#
    ...
    fn a_choice_dialog_is_waiting_not_running() {
        for spinner in [SpinnerMotion::Live, SpinnerMotion::Frozen] {
            assert_eq!(
                infer_agent_status_from_visible_text(choice_dialog_screen(), None, spinner),
                AgentStatus::WaitingForInput,
    ...
    fn an_adapter_running_pattern_still_beats_a_dialog() {
        ...
        assert_eq!(
            infer_agent_status_from_visible_text(&screen, Some(&adapter), SpinnerMotion::Live),
            AgentStatus::Running
        );
    }
    ...
    fn a_working_pane_still_spins_without_an_interrupt_hint() {
        ...
        assert_eq!(
            infer_agent_status_from_visible_text(working_screen(), None, SpinnerMotion::Live),
            AgentStatus::Running
        );
        assert_eq!(
            infer_agent_status_from_visible_text(working_screen(), None, SpinnerMotion::Frozen),
            AgentStatus::WaitingForInput,
